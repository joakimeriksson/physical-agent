...
```bash
cd browser-labs/lab1_chat_agent
python -m http.server 9090        # or: uv run python -m http.server 9090
```
...
|-----|-------------|----------|
| [lab1_chat_agent](lab1_chat_agent/) | Chat with an AI that calls tools (calculator, time, dice) | Ollama |
| [lab2_business_coach](lab2_business_coach/) | AI evaluates your meeting readiness | Webcam, Ollama VLM |
...
1. **lab1_chat_agent** — Start here. Chat with AI, see tool calling in action.
2. **lab2_business_coach** — Fun demo with webcam. Needs a vision model (gemma3).
